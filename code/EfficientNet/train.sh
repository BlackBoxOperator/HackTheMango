...
python train.py --model-name tf_efficientnet_b4 --epochs 12 --lr 0.00025 --batch-size 32 --augment 2 --finetune 1 --dataset final --weight-name effb4final1w | tee effb4final1.txt
python train.py --model-name tf_efficientnet_b4 --epochs 12 --lr 0.00025 --batch-size 32 --augment 2 --finetune 2 --dataset final --weight-name effb4final2w | tee effb4final2.txt
python train.py --model-name tf_efficientnet_b4 --epochs 12 --lr 0.00025 --batch-size 32 --augment 2 --finetune 3 --dataset final --weight-name effb4final3w | tee effb4final3.txt
python train.py --model-name tf_efficientnet_b4 --epochs 12 --lr 0.00025 --batch-size 32 --augment 2 --finetune 4 --dataset final --weight-name effb4final4w | tee effb4final4.txt
python train.py --model-name tf_efficientnet_b6 --epochs 12 --lr 0.00025 --batch-size 18 --augment 2 --finetune 1 --dataset final --weight-name effb6final1w | tee effb6final1.txt
python train.py --model-name tf_efficientnet_b6 --epochs 12 --lr 0.00025 --batch-size 16 --augment 2 --finetune 2 --dataset final --weight-name effb6final2w | tee effb6final2.txt
python train.py --model-name tf_efficientnet_b6 --epochs 12 --lr 0.00025 --batch-size 16 --augment 2 --finetune 3 --dataset final --weight-name effb6final3w | tee effb6final3.txt
python train.py --model-name tf_efficientnet_b6 --epochs 12 --lr 0.00025 --batch-size 16 --augment 2 --finetune 4 --dataset final --weight-name effb6final4w | tee effb6final4.txt
